...
public class OwnerTablePanel extends JPanel {
    ...
    public OwnerTablePanel(OwnerData ownerData, User currentUser, JLabel statusLabel) {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && ownerTable.getSelectedRow() != -1) {
                    if (currentUser.isAdmin()) {
                        ...
                        Owner owner = ownerData.getOwnerById(petId);
    ...
    public void loadOwnersIntoTable(OwnerData ownerData) {
        tableModel.setRowCount(0);

        for (Owner owner : ownerData.getOwnerList()) {
    ...
    private void sortByColumn(int columnIndex) {
        ...
        ownerData.sortOwnersBy(comparator);
        loadOwnersIntoTable(ownerData);
    }
